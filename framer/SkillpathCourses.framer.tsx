...
/**
 * Skillpath - Courses Section Code Component for Framer
 * 
 * Features:
 * - Live data fetch from https://syncsphere-hiv6.onrender.com/assignment/course-data
 * - Country detection & currency switcher from /assignment/country-code
 * - SWR Caching & Flaky API resilience: Exponential auto-retry + graceful fallback
 * - 4 States: Loading (Skeletons), Error (with Retry), Empty state, Working grid
 * - Accurate currency math: pricePaise / 100 -> INR, priceUsdCents / 100 -> USD
 * - 2-line clean description clamping
 * - Responsive 3/2/1 Column layout
 * - Framer Property Controls for Section Title, Subtitle, Fallback Currency, Accent Color, and Search toggle.
 */
